import { DevtoolsPlugin, genDataChangeTransaction, type DevtoolsPluginOptions } from "@player-devtools/plugin";
...
export class ProfilerDevtoolsPlugin extends DevtoolsPlugin {
    ...
    apply(player: Player): void {
        ...
        this.stopProfiler = stopProfiler;
    ...
    processInteraction(interaction: DevtoolsPluginInteractionEvent): void {
        ...
        if (type === INTERACTIONS.STOP_PROFILING && this.stopProfiler) {
          const { rootNode, durations } = this.stopProfiler();
          ...
          // const newState = produce(this.store.getState(), (draft) => {
          //   dset(draft, ["plugins", pluginID, "flow", "data", "rootNode"], rootNode);
          //   dset(draft, ["plugins", pluginID, "flow", "data", "durations"], durations);
          //   dset(draft, ["plugins", pluginID, "flow", "data", "profiling"], false);
          //   dset(
          //     draft,
          //     ["plugins", pluginID, "flow", "data", "displayFlameGraph"],
          //     true,
