...
@testable import PlayerUIDevtoolsBaseProfilerDevtoolsPlugin

final class BaseProfilerDevtoolsPluginTests: XCTestCase {

    var context: JSContext!
    var testHandler: TestHandler!
    var plugin: BaseProfilerDevtoolsPlugin!
    ...
    override func setUp() {
        ...
        plugin = BaseProfilerDevtoolsPlugin(playerID: testPlayerID)
    ...
    func testInitializationWithVariousPlayerIDs() {
        ...
        for playerID in testCases {
            let testPlugin = BaseProfilerDevtoolsPlugin(playerID: playerID)
    ...
    func testPluginConfiguration() {
        ...
        XCTAssertEqual(plugin.fileName, "ProfilerDevtoolsPlugin.native")
    }
}
