# @player-devtools/desktop-common
...
The `@player-devtools/desktop-common` package is a part of the Player UI Devtools architecture. It provides a set of common utilities that can be used to create custom devtools plugins for the Player UI.
...
```bash
npm install @player-devtools/desktop-common

yarn add @player-devtools/desktop-common
```
...
import {
  communicationLayer,
  usePluginState,
} from "@player-devtools/desktop-common";
```
