...
PLUGINS=("@player-devtools/basic-web-plugin" "@player-devtools/profiler-web-plugin")

# Define browser-devtools depenedencies
BROWSER_DEVTOOLS_DEPS=("@player-ui/pubsub-plugin" "dequal" "@player-devtools/client@0.0.0-PLACEHOLDER" "@player-devtools/messenger@0.0.0-PLACEHOLDER" "@player-devtools/types@0.0.0-PLACEHOLDER")
