...
The `@player-devtools/desktop-basic` package is a part of the Player UI Devtools architecture.
...
```ts
import { BasicWevDevtoolsPlugin } from "@player-devtools/desktop-basic";
```
