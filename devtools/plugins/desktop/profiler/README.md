# @player-devtools/profiler-web-plugin
...
The `@player-devtools/profiler-web-plugin` package is a part of the Player UI Devtools architecture.
...
```bash
npm install @player-devtools/desktop-basic
```

```bash
yarn add @player-devtools/desktop-basic
```
...
```ts
import { ProfilerPlugin } from "@player-devtools/profiler-web-plugin";
```
